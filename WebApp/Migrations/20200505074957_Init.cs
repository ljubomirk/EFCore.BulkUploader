    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "Create Promotion", 0, "POS", new DateTime(2020, 5, 5, 9, 49, 56, 484, DateTimeKind.Local).AddTicks(6782), "" },
                    { 2L, "Update Coupon", 1, "", new DateTime(2020, 5, 5, 9, 49, 56, 487, DateTimeKind.Local).AddTicks(4817), "korisnik" }
                });
